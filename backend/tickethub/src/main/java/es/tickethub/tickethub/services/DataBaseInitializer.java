...
public class DataBaseInitializer {
    ...
    public List<Event>  initializeEvents(List<Artist> artists) {
    ...
    public Client initializeUsers(List <Image> clientImages) {
        ...
        Client defaultClient = new Client("pepe@gmail.com", "PepeG", "pepe123", "Pepe", "Garcia", 33, 666666666, BigDecimal.ZERO, null, null, null);
    ...
    public List<Session> initializeSessions(List<Event> events) {
        ...
        List<Session> sessions = Arrays.asList(
            new Session(events.get(0), Timestamp.valueOf("2026-06-10 21:00:00")),
            new Session(events.get(1), Timestamp.valueOf("2026-06-11 21:00:00")),
            new Session(events.get(2), Timestamp.valueOf("2026-06-12 21:00:00"))
        );
    ...
    public void initializePurchases(Client client, Session session) {

            List<Ticket> tickets = Arrays.asList(
            new Ticket("QR1", session, new BigDecimal("45.00"), true),
            new Ticket("QR2", session, new BigDecimal("45.00"), true),
            new Ticket("QR3", session, new BigDecimal("80.00"), true),
            new Ticket("QR4", session, new BigDecimal("120.00"), true)
        );
    ...
    public void initializeDataBase() {
        ...
        List<Event> events = initializeEvents(artists);
        ...
        initializePurchases(defaultClient, sessions.get(0));
    }
